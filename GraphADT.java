...
public interface GraphADT<T> {
  ...
  /**
   * Returns the shortest path between startingVertex and destinationVertex. Uses Dijkstra's
   ...
   *         item startingVertex and vertex with data item destinationVertex, including both
   *         startingVertex and destinationVertex
   */
  public List<T> shortestPath(T start, T end);

  /**
   * Returns the cost of the path (sum over edge weights) between startingVertex and
   * destinationVertex. Uses Dijkstra's shortest path algorithm to find the shortest path.
   * 
   * @param start the data item in the starting vertex for the path
   * @param end   the data item in the destination vertex for the path
